...
import "@openzeppelin/contracts/utils/introspection/IERC1820Registry.sol"; // 一个用于注册和查找智能合约的标准接口
import "./IERC777.sol";
...
contract ERC777 is Context, IERC777, IERC20 {
    ...
    // 它永远不会被读取--它只用于响应defaultOperator查询。这个变量只是在合约部署时被赋初值，用于给_defaultOperators做映射，之后基本不再会被用到。
    ...
    constructor(
        ...
        // register interfaces
        // setInterfaceImplementer: 将一个智能合约地址注册为一个接口的实现者,从而让其他智能合约能够方便地查找和调用它的接口。
    ...
    function _send(
        ...
        // ERC777 的重入攻击可能就在此实现，register中的ERC777TokensRecipient的只需要重写tokensReceived方法中的逻辑
        // 案例可以看 StackingStudy 文件中 MockERC777Attack.sol 的部分。
        _callTokensReceived(
            operator,
            from,
            to,
    ...
    function _callTokensToSend(
        ...
        // getInterfaceImplementer: 查找一个智能合约地址所实现的接口
